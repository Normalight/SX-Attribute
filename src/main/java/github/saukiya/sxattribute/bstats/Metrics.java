...
public class Metrics {
    ...
    /**
     * A toCollection with all custom charts
     */
     ...
     * Class constructor.
     *
     * @param plugin The plugin which attribute should be submitted.
     */
    ...
    private void startSubmitting() {
        ...
        executorService.scheduleAtFixedRate(() ->
        {
             ...
             * Don't be afraid! The connection to the bStats server is still async, only the attribute collection is sync ;)
             */
     ...
     * This event Method is called using Reflection.
     *
    ...
    private JSONObject getServerData() {
        ...
        try {
            ...
            // Just use the new event Method if the Reflection failed
        ...
        Executors.newSingleThreadExecutor().execute(() ->
        {
            try {
                ...
                if (logFailedRequests) {
                    plugin.getLogger().log(Level.WARNING, "Could not submit plugin attribute of " + plugin.getName(), e);
                }
            }
        });
    }
